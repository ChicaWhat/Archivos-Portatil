// Importamos la función que devuelve una función a la base de datos
import getPool from "../../db/getPool.js";

// Importamos los errores
import { notFoundError } from "../../services/errorService.js";

// Función que realiza una consulta en la base de datos para seleccionar un usuario con un id dado
const selectUserByIdModel = async (userId) => {
    ...
    const [users] = await pool.query(
        ...
        // de retornar un array con un element
        return users[0];
};
