...
const authUserController = async (req, res, next) => {
    try {
        ...
        try {
            ...
            // 2. Si hemos llegado hasta aquí quiere decir que el token ya se ha desencriptado.
            // Creamos la propiedad "user" en el objeto "request" (es una propiedad inventada)...
            req.user = tokenInfo;

            // 3. Pasamos el control a la siguiente función controladora. Dado que todas las funciones
